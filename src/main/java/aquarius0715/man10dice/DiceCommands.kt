                    ...
                    1 -> {
                        when (args[0]) {
                            ...
                            "help" -> {
                                ...
                                sender.sendMessage("${plugin.prefix}${ChatColor.DARK_AQUA}${ChatColor.BOLD}/mdice local [面] : 面を指定して、半径20ブロック内に通知するダイスを振ります。")
                    ...
                    2 -> {
                        when (args[0]) {
                            ...
                            "local" -> {
                                ...
                                plugin.dice.localDice(sender, args[1].toInt())
                                return true
                            }
                        }
                    }
